                    ...
                    <div class="row" v-show="type_answer_has_additional_data">
                        <div class="form-group col-xs-12 m-b-0">
                            <div class="droppable droppable-small">
                                ...
                                <input v-bind:name="'answers['+index2+'][photo]'" type="file" @change="openCropImage($event, handleCrop, type, index2)">
                                <input v-bind:name="'answers['+index2+'][photo_cropped]'" type="hidden" :value="answer.photo" >
                            </div>
