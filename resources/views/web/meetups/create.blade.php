@section('page_title', 'Create meetup')
@extends('layouts.master')

@section('breadcrumbs')
    @include('partials.breadcrumbs', [
        'pageTitle' => 'Create meetup',
        'breadcrumbs' => [
            [ 'label' => 'Brightfox', 'url' =>  route('dashboard')],
            [ 'label' => 'Meetups', 'url' => route('meetups.index')]
        ],
        'currentSection' => 'Create meetup',
    ])
@endsection
                ...
                <div class="card-box">
                    <div class="row">
                        <div class="form-group col-sm-6 {{ $errors->has('date')? 'has-error' : '' }}">
                            ...
                            <input type="text" name="date" class="form-control datepicker-meetup" value="{{ old('date') }}">
                            @if($errors->has('date'))
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6 {{ $errors->has('start_time')? 'has-error' : '' }}">
                            ...
                            <input type="text" name="start_time" class="form-control timepicker" value="{{ old('start_time') }}">
                        ...
                        <div class="form-group col-sm-6 {{ $errors->has('end_time')? 'has-error' : '' }}">
                            ...
                            <input type="text" name="end_time" class="form-control timepicker" value="{{ old('end_time') }}">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6 {{ $errors->has('location')? 'has-error' : '' }}">
                            ...
                            <select id="location" name="location" class="form-control" data-selected="{{ old('location') }}" @change="getRoomsAndInstructorsFromLocation('{{ route('rooms.by_location') }}', '{{ route('employees.by_location') }}', $event)">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6 {{ $errors->has('room')? 'has-error' : '' }}">
                            ...
                            <select id="room" name="room" class="form-control" data-selected="{{ old('room') }}">
                            </select>
                            @if($errors->has('room'))
                                <span class="help-block">
                        ...
                        <div class="form-group col-sm-6 {{ $errors->has('user')? 'has-error' : '' }}">
                            ...
                            <select id="user" name="user" class="form-control" data-selected="{{ old('user') }}">
                            </select>
                            @if($errors->has('user'))
                                <span class="help-block">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="checkbox checkbox-primary">
                                <input id="existing_ab" type="checkbox" v-model="add_existing_activity_bucket" @change="loadActivityBuckets('{{ route('activity_buckets.for_meetup') }}', $event)">
                    ...
                    <div v-if="add_existing_activity_bucket">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6 {{ $errors->has('subject')? 'has-error' : '' }}">
                                ...
                                <select id="subject" name="subject" class="form-control" data-selected="{{ old('subject') }}" v-model="subject" @change="loadActivityBuckets('{{ route('activity_buckets.for_meetup') }}', $event)">
                                </select>
                                ...
                                <tr v-for="activity_bucket in activity_buckets">
                                    <td>
                                        <div class="radio radio-primary">
                                            <input type="radio" name="activity_bucket" v-bind:value="activity_bucket.id">
                                            <label></label>
                                        </div>
                                    </td>
                    ...
                    <div class="row">
                        <div class="form-group col-md-12 text-right">
                            ...
                            <button type="submit" class="btn btn-md btn-primary" v-if="add_existing_activity_bucket">Create</button>
