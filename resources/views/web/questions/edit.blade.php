                ...
                <div class="card-box">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6 col-md-3 {{ $errors->has('grade_level')? 'has-error' : '' }}">
                            ...
                            <select id="grade_level" name="grade_level" class="form-control" data-selected="{{ old('grade_level', $item->topic->subject->grade_level->id) }}" @change="getSubjectsFromGradeLevel('{{ route('subjects.by_grade') }}', $event)">
                        ...
                        <div class="form-group col-sm-6 col-md-3 {{ $errors->has('subject')? 'has-error' : '' }}">
                            ...
                            <select id="subject" name="subject" class="form-control" data-selected="{{ old('subject', $item->topic->subject->id) }}" @change="getTopicsFromSubject('{{ route('topics.by_subject') }}', $event)">
                            </select>
                        ...
                        <div class="form-group col-sm-6 col-md-3 {{ $errors->has('topic')? 'has-error' : '' }}">
                            ...
                            <select id="topic" name="topic" class="form-control" data-selected="{{ old('topic', $item->topic->id) }}">
                            </select>
                            @if($errors->has('topic'))
                                <span class="help-block">
