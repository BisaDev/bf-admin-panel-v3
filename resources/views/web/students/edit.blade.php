                ...
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6 {{ $errors->has('birthdate')? 'has-error' : '' }}">
                            ...
                            <input type="text" name="birthdate" class="form-control datepicker" value="{{ old('birthdate', $item->birthdate->format('m/d/Y')) }}">
                        ...
                        <div class="form-group col-lg-6 {{ $errors->has('gender')? 'has-error' : '' }}">
                            ...
                            <select name="gender" class="form-control">
                                ...
                                <option value="{{ $key }}" {{ (old('gender', (int)$item->gender->key) === $key)? 'selected' : '' }}>{{ $gender }}</option>
                                @endforeach
                            </select>
