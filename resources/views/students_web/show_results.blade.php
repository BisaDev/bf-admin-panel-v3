        ...
        @foreach($item->sections as $section)
            <div class="row">
                <div class="card-box col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('answer_sheet.edit_understood', $section->id)}}" method="POST"
                                ...
                                <table class="table table-responsive table-hover model-list text-center">
                                    ...
                                    @foreach($section->questions as $question)
                                        <tr>
                                            ...
                                            <td>{{ $question->guessed ? 'Guessed' : '-' }}</td>
                                            @if($question->answer === $question->correctAnswer->correct_1 || $question->answer === $question->correctAnswer->correct_2 || $question->answer === $question->correctAnswer->correct_3 || $question->answer === $question->correctAnswer->correct_4 || $question->answer === $question->correctAnswer->correct_5)
                                                ...
                                                @if($question->guessed)
                                                    <td><input type="checkbox"
                                                               name={{'understood_' . $section->section_number . '_' . $question->question_number}}>
                                                    </td>
                                                @else
                                                    <td><span class="badge badge-pill badge-success"><i
                                                                    class="ti-check"></i></span></td>
                                                @endif
                                            @else
                                ...
                                <div class="row container">
                                    <div class="form-group col-md-12 text-right">
                                        <p class="text-left"> Double check the guessed or incorrect questions, if you
                                            understand them mark the corresponding "I get it now" box. When you are
                                            done, hit the "Save" button.</p>
